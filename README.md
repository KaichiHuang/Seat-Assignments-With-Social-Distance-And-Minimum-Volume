...
![演講廳單音箱_A](https://user-images.githubusercontent.com/120470999/210210581-bfcdf56a-725e-4c83-9664-56251ee47b91.png)

##### 3.3.1.2 考慮新增第二個擴音設備

根據上圖我們可以發現左邊區域雖然已有座位被選取，但仍占少數，因此我們將考慮新增第二個擴音設備作為情境，求解後可得知A～E，任一個搭配在以下三個位置放置擴音設備，都能達到最佳解：46個座位。但要注意的是畫圖出來僅有音箱2與音箱3能達到（解=47）。
音箱1= [230,15,70]、音箱2= [230,35,70]、音箱3= [230,55,70]
